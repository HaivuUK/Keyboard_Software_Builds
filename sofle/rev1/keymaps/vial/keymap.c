 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LGUI | LAlt |  UP  | LEFT | /Enter  /       \Space \  |RAISE |RIGHT | DOWN | RGUI |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
...
[0] = LAYOUT(
  ...
  KC_LCTL,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,     XXXXXXX,KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
                 KC_LGUI,KC_UP,KC_LEFT, MO(2), KC_ENT,      KC_SPC,  MO(3), KC_RIGHT, KC_DOWN, KC_RGUI
),
/*
 * GAMING
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[1] = LAYOUT(
  ...
  KC_LSFT,   KC_A,   KC_R,    KC_S,    KC_T,    KC_D,                      KC_H,    KC_N,    KC_E,    KC_I,    KC_UP,  KC_QUOT,
  KC_LCTL,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,      XXXXXXX,KC_K,    KC_M, KC_COMM,  KC_LEFT, KC_DOWN,  KC_RIGHT,
